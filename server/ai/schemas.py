# Canonical AI output schemas -- docs/ai_pipelines.md §2/§3. Ported verbatim from
# contrib/aneesh/backend/ai/schemas.py.
...
class AnomalyResult(BaseModel):
    anomaly_id: str
    anomaly_type: str  # open string, not a fixed enum -- docs/ai_pipelines.md §2
    confidence: float
    camera_uid: str
    timestamp: datetime
    frame_sequence: int
